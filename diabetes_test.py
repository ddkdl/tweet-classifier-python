...
if __name__ == "__main__":
    ...
    for c in c_list:
        ...
        predFile = open("results/diabetes_linear_kernel_c_" + c + ".txt", "w")
        statFile = open("results/diabetes_linear_kernel_c_" + c + "_stats.txt", "w")
    ...
    for c in c_list:
        ...
        predFile = open("results/diabetes_polynomial_kernel_c_" + c + ".txt", "w")
        statFile = open("results/diabetes_polynomial_kernel_c_" + c + "_stats.txt", "w")
    ...
    for sigma in sigma_list:
        for c in c_list:
            ...
            predFile = open("results/diabetes_gaussian_kernel_s_" + sigma + "_c_" + c + ".txt", "w")
            statFile = open("results/diabetes_gaussian_kernel_s_" + sigma + "_c_" + c + "_stats.txt", "w")
